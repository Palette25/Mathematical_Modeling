%% 求解广州市人才吸引力水平的Matlab程序实现 %%
%% 发展前景 %%
workers = xlsread("广州全社会劳动人员");
prodAll = xlsread("广州生产总值");

%% 行业前景 %%
company = xlsread("广州市企业总数");
greatCom = xlsread("广州市高新企业发展值");

%% 收入 %%
GDPPer = xlsread("广州人均GDP");
IncomePer = xlsread("广州人均可支配收入");
SalaPer = xlsread("广州职工工资发展指数");

%% 居住环境 %%
tran = xlsread("广州公路交通");
educa = xlsread("广州教育情况");
stores = xlsread("广州市商业综合体");
welfare = xlsread("广州市社会福利");
price = xlsread("广州市物价指数");
hosp = xlsread("广州卫生事业");
envir = xlsread("广州市自然环境");

%% 面向双工序动态调度器的模拟退火算法，进行模型上的优化 %%

function [optimal_result, optimal_num] = SimulatedAnnealingSchedulerTwo(init_result, init_num, init_temp, iterate_time, R1, R2, R3, T1, T2, n1, n2, W)
